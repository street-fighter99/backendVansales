...
public class CustomerService {
    ...
    public ResponseEntity updateAll(CustomerModel customerModel) {
        customerRepo.updateAll(customerModel.getName(),customerModel.getVatNo(),customerModel.getCbalance(),customerModel.getIsactive(),customerModel.getAddress(),customerModel.getCsId(),customerModel.getUserId());
